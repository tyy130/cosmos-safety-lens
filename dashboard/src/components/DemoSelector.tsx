...
const DEMO_CLIPS: DemoClip[] = [
  ...
  { id: 'clip-3', label: 'Normal Driving Baseline', description: 'Nexar negative sample — standard urban driving baseline', url: 'https://huggingface.co/datasets/nexar-ai/nexar_collision_prediction/resolve/main/test-public/negative/01044.mp4' }
];
